...
final class Post_Translator {
	...
	const ELEMENTOR_CHUNK_FAST_FAIL_RETRIES = Post_Translator_Config::ELEMENTOR_CHUNK_FAST_FAIL_RETRIES;
	...
	const ELEMENTOR_HUGE_FIELD_SEGMENT_THRESHOLD = Post_Translator_Config::ELEMENTOR_HUGE_FIELD_SEGMENT_THRESHOLD;
	const ELEMENTOR_HUGE_FIELD_SEGMENT_BATCH_SIZE = Post_Translator_Config::ELEMENTOR_HUGE_FIELD_SEGMENT_BATCH_SIZE;
