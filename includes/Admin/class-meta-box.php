		...
		wp_localize_script(
			...
			array(
				...
				'strings'        => array(
					...
					'elementorFilteredOut' => __( 'فیلترشده (کلید غیروایت‌لیست / HTML)', 'polymart-ai' ),
					'elementorFilteredOutHint' => __( 'این فیلدها در JSON فارسی دارند ولی فعلاً در صف ترجمه نیستند:', 'polymart-ai' ),
					'elementorMediaUrls' => __( 'URL رسانه با نام فارسی (متن صفحه نیست)', 'polymart-ai' ),
					'elementorNotServed' => __( 'روی /en/ سرو نمی‌شود', 'polymart-ai' ),
					'elementorServedOk'  => __( 'آماده سرو روی /en/', 'polymart-ai' ),
					'elementorStorefrontPersian' => __( 'فروشگاه هنوز منبع فارسی نشان می‌دهد', 'polymart-ai' ),
					'elementorServeBlocked' => __( 'چرا /en/ فارسی می‌ماند:', 'polymart-ai' ),
					'forceRetranslateHint' => __( 'برای ترجمه از صفر همین زبان: Shift + کلیک روی «ترجمه و تکمیل این زبان».', 'polymart-ai' ),
					'scanLooksDoneButFrontFa' => __( 'صف فیلدها خالی است ولی فروشگاه هنوز فارسی سرو می‌کند — ترجمه از صفر (Shift+«ترجمه و تکمیل») یا دیاگ صف را ببینید.', 'polymart-ai' ),
					'elementorKindMedia' => __( 'رسانه', 'polymart-ai' ),
					'elementorKindBlocked' => __( 'کلید مسدود', 'polymart-ai' ),
					'elementorKindOther' => __( 'سایر', 'polymart-ai' ),
					'elementorApiPayloadHint' => __( 'نمونه متنی که به آروان می‌رود (نه JSON Elementor خام):', 'polymart-ai' ),
					'elementorUniqueTexts' => __( 'متن یکتا', 'polymart-ai' ),
					'elementorApiBatches' => __( 'درخواست API', 'polymart-ai' ),
					'elementorLongRemaining' => __( 'متن‌های بلند مانده', 'polymart-ai' ),
